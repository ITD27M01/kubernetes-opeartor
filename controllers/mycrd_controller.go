...
import (
	...
	examplev1alpha1 "github.com/itd27m01/kubernetes-operator/api/v1alpha1"
)
...
//+kubebuilder:rbac:groups=example.itd27m01.com,resources=mycrds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=example.itd27m01.com,resources=mycrds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=example.itd27m01.com,resources=mycrds/finalizers,verbs=update
